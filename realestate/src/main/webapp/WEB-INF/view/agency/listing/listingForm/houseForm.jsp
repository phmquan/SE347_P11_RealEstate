                    ...
                    <div class="container px-4">
                        <div class="bg-white p-4 shadow-sm rounded p-3">
                            ...
                            <ol class="breadcrumb mb-4">
                                ...
                                <li class="breadcrumb-item active">Tạo bài đăng BĐS nhà ở</li>
                            </ol>
                            <div class="container mt-3">
                                <form:form method="post" action="/agency/listing/create?type=house"
                                    modelAttribute="newListing" enctype="multipart/form-data">

                                    <input type="text" path="propertyType" value="house" hidden />
                                    <div class="row g-3">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col mb-3">
                                            <c:set var="errorhouseAddress">
                                                <form:errors path="property.address" cssClass="invalid-feedback" />
                                            </c:set>
                                            <label class="form-label">Địa chỉ</label>
                                            <form:input type="text"
                                                class="form-control ${not empty errorhouseAddress ? 'is-invalid':''}"
                                                path="property.address" />
                                            ${errorhouseAddress}
                                        </div>
                                        <div class="col mb-3">
                                            <c:set var="errorhouseDistrict">
                                                <form:errors path="property.district" cssClass="invalid-feedback" />
                                            </c:set>
                                            <label class="form-label">Quận</label>
                                            <form:select
                                                class="form-select ${not empty errorhouseDistrict ? 'is-invalid':''}"
                                        ...
                                        <div class="row g-3">
                                            <div class="col mb-3">
                                                ...
                                                <label for="exampleInputPassword1" class="form-label">Diện
                                                    tích nhà ở (m2)</label>
                                                <form:input type=""
                                                    class="form-control ${not empty errorhouseArea ? 'is-invalid':''}"
                                                    path="property.propertyArea" />
                                                ${errorhouseArea}
                                            </div>
                                            <div class="col mb-3">
                                                <c:set var="errorhousePrice">
                                                ...
                                                <label for="exampleInputPassword1" class="form-label">Giá
                                                    khu nhà ở</label>
                                                <form:input type="text"
                                                    class="form-control ${not empty errorhousePrice? 'is-invalid':''}"
