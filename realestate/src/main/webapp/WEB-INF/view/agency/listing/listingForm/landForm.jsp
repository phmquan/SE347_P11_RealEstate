                    ...
                    <div class="container px-4">
                        <div class="bg-white p-4 shadow-sm rounded p-3">
                            ...
                            <div class="container mt-3">
                                <form:form method="post" action="/agency/listing/create?type=land"
                                    modelAttribute="newListing" enctype="multipart/form-data">

                                    <input type="text" path="propertyType" value="LAND" hidden />
                                    <div class="row g-3">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col mb-3">
                                            <c:set var="errorLandAddress">
                                                <form:errors path="property.address" cssClass="invalid-feedback" />
                                            </c:set>
                                            <label class="form-label">Địa chỉ</label>
                                            <form:input type="text"
                                                class="form-control ${not empty errorLandAddress ? 'is-invalid':''}"
                                                path="property.address" />
                                            ${errorLandAddress}
                                        </div>
                                        <div class="col mb-3">
                                            <c:set var="errorLandDistrict">
                                                <form:errors path="property.district" cssClass="invalid-feedback" />
                                            </c:set>
                                            <label class="form-label">Quận</label>
                                            <form:select
                                                class="form-select ${not empty errorLandDistrict ? 'is-invalid':''}"
                                        ...
                                        <div class="row g-3">
                                            <div class="col mb-3">
                                                ...
                                                <label for="exampleInputPassword1" class="form-label">Diện
                                                    tích đất (m2)</label>
                                                <form:input type=""
                                                    class="form-control ${not empty errorLandArea ? 'is-invalid':''}"
                                                    path="property.propertyArea" />
                                                ${errorLandArea}
                                            </div>
                                            <div class="col mb-3">
                                                <c:set var="errorLandPrice">
                                                ...
                                                <label for="exampleInputPassword1" class="form-label">Giá
                                                    khu đất</label>
                                                <form:input type="text"
                                                    class="form-control ${not empty errorLandPrice? 'is-invalid':''}"
