...
public class AgencyController {
    ...
    public AgencyController(BrokerCertificationService brokerCertificationService, UploadService uploadService, AgencyService agencyService, PasswordEncoder passwordEncoder, UserService userService) {
    ...
    public String createAgency(@ModelAttribute("newAgency") @Valid Agency agency, BindingResult bindingResult, Model model, @RequestParam("file") MultipartFile file) {
    ...
    public String handleUpdateAgency(@ModelAttribute("updateAgency") @Valid Agency agency, BindingResult bindingResult, Model model, @RequestParam("file") MultipartFile file) {
